<?
$title ='Музыка';
$og_title = 'Лучшие колыбельные для малышей';
$og_url = 'music.php';
$og_image = 'img/shares/share_music.jpg';
$og_description = 'Музыка поможет вашему малышу развить воображение и почувствовать гармонию с окружающим миром. Различные музыкальные инструменты — пианино, флейта, ксилофон — разбудят фантазию и вызовут приятные эмоции. Включите ребенку спокойную музыку на ночь, и он быстрее расслабится и уснет.';
