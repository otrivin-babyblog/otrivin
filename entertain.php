    ...
    <div class="wrapper entertain">
      ...
      <div class="content">
        ...
        <div class="zoo-links-wrapper">
          ...
          <a href="/game.php" class="btn btn__zoo">начать игру</a>
        </div>
        <div class="activities-wrapper">
          ...
          <div class="activity">
            ...
            <a href="/contests_s.php" class="activity__link">Подробнее</a>
          </div>
          <!--div class="activity">
        ...
        <div class="activities-wrapper activities-wrapper_reversed">
          ...
          <div class="activity">
            ...
            <a href="/tales.php" class="activity__link">Подробнее</a>
          </div>
          <div class="activity">
            ...
            <a href="/music.php" class="activity__link">Подробнее</a>
          </div>
          <div class="activity">
            ...
            <a href="/verses.php" class="activity__link">Подробнее</a>
          </div>
        </div>
