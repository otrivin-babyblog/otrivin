...
!function (a) {
  ...
  !function () {
    ...
    var e,
        ...
        i = this.optional(c);if (i) return i;if ("file" === a(c).attr("type") && (h = h.replace(/[\-\[\]\/\{\}\(\)\+\?\.\\\^\$\|]/g, "\\$&").replace(/,/g, "|").replace("/*", "/.*"), c.files && c.files.length)) for (g = new RegExp(".?(" + h + ")$", "i"), e = 0; e < c.files.length; e++) {
...
jQuery(document).ready(function () {
  ...
  $('.js-validate').validate({
    ...
    errorPlacement: function errorPlacement(error, element) {
      error.appendTo(element.parents('.input-row'));
    },
    rules: {
      attachment: {
        required: true,
  ...
  jQuery.extend(jQuery.validator.messages, {
    ...
    accept: "Пожалуйста загрузите файл с правильным расширением",
    extension: jQuery.validator.format("Пожалуйста загрузите файл с правильным расширением"),
    maxlength: jQuery.validator.format("Пожалуйста используйте не больше {0} символов")
  });
});