			...
			<div class="container">
							...
							<div class="main_info">
								...
								<div class="main_info_item">
									<div class="main_info_link">
										<p><img src="img/main-line.png" alt=""></p>
										<a href="/no_more_cold.php" class="info_a">Прощай, насморк <i><img src="img/down-arrow.svg" alt=""></i></a>
										<div class="main_but"><a href="/nose_hygiene.php"><span>Ознакомиться</span></a> <img src="img/elephant.png" alt=""></div>
									</div>
						...
						<li>
							<div class="main_info">
								...
								<div class="main_info_item">
									<div class="main_info_link">
										<p><img src="img/main-line.png" alt=""></p>
										<a href="/entertain.php" class="info_a">Развлекай ребёнка <i><img src="img/down-arrow.svg" alt=""></i></a>
										<div class="main_but"><a href="/entertain.php"><span>Перейти в раздел</span></a> <img src="img/elefant_twice.png" alt=""></div>
									</div>
						...
						<li>
							<div class="main_info">
								...
								<div class="main_info_item">
									<div class="main_info_link">
										<p><img src="img/main-line.png" alt=""></p>
										<a href="/save.php" class="info_a">Сохраняй важное <i><img src="img/down-arrow.svg" alt=""></i></a>
										<div class="main_but"><a href="/save.php"><span>Создать заметки</span></a> <img src="img/while.png" alt=""></div>
									</div>
						...
						<li>
							<div class="main_info">
								...
								<div class="main_info_item">
									<div class="main_info_link">
										<p><img src="img/main-line.png" alt=""></p>
										<a href="/calendar.php" class="info_a">Планируй день <i><img src="img/down-arrow.svg" alt=""></i></a>
										<div class="main_but"><a href="/calendar.php"><span>Начать планировать</span></a> <img src="img/penguim.png" alt=""></div>
									</div>
				...
				<div class="main_bot">
					<div class="main_bot_item">
						<img src="img/disckl.png" alt="" class="disckl">
						<img src="img/disckl-320.png" alt="" class="disckl-320">
					</div>
				</div>
			</div>
		</div>
