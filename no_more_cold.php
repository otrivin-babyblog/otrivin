  ...
  <div class="wrapper no_more_cold">
      ...
      <div class="content">
		...
		<div id="links-container">
		  <a id="piluli" class="otrivin-instructions"  href="http://www.piluli.ru/product/Otrivin_behbi" target="_blank" >Купить на Piluli</a>
       
	      <a id="apteka" class="otrivin-instructions" href="http://apteka.ru/search/?q=%D0%BE%D1%82%D1%80%D0%B8%D0%B2%D0%B8%D0%BD+%D0%B1%D1%8D%D0%B1%D0%B8&order=products%2Cmaterials&vendor=&shop=" target="_blank">Купить на Apteka.ru</a>
       </div>
        ...
        <div class="useful-articles">
          ...
          <ul class="useful-list">
		   ...
		   <li class="useful__item">
              <a href="<? echo $source; ?>article7.php" class="useful__link otrivin-lesson-7"><span>Урок 7</span>"Чтобы дышалось хорошо"</a>
            </li>
           </li>
			  <li class="useful__item">
