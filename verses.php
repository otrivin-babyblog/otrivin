<?
$title ='Потешки';
$og_title = 'Забавные стишки для малышей';
$og_url = 'verses.php';
$og_image = 'img/shares/share_home_tasks.jpg';
$og_description = 'Созданные нашими прабабушками для потехи малых детушек, потешки оказывают большую помощь и нам. Они учат детей говорить первые слова, делать первые шаги, с потешками можно умываться, расчесываться, кушать кашку, гулять, танцевать.';
